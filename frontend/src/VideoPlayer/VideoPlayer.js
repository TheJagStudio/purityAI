			...
			<div className="relative group flex items-center justify-center flex-col-reverse lg:w-[80%] w-[90%] my-5 mx-auto md:rounded-xl rounded-md overflow-hidden">
				...
				<div className="w-full h-auto transition-all duration-200 opacity-0 group-hover:opacity-100 absolute bottom-0 left-0 md:pt-2 pb-3 py-2 md:px-4 px-3 rounded-b-xl z-10 flec items-center flex-col bg-black/80 ">
					...
					<div className="w-full mb-2">
						<input type="range" min="0" max="13" step="0.1" value={currTime} onChange={handleSliderChange} id="seekBar" className="w-full h-0.5 cursor-pointer" />
					</div>
					...
					<div className="flex items-center gap-3">
						...
						<div className="flex items-center peer justify-center gap-2">
							{volumeValue >= 70 ? (
								<p onClick={handleMute} className="hover:cursor-pointer">
									<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="white" class="bi bi-volume-up-fill" viewBox="0 0 16 16">
								...
								<p onClick={handleMute} className="hover:cursor-pointer">
									<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="white" class="bi bi-volume-down-fill" viewBox="0 0 16 16">
								...
								<p onClick={handleMute} className="hover:cursor-pointer">
									<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="white" class="bi bi-volume-mute-fill" viewBox="0 0 16 16">
						...
						<div className="flex items-center justify-center gap-1 text-white">
							<p>
								{toMinAndHrs(parseInt(currTime))} / {toMinAndHrs(maxSeconds)}
							</p>
						</div>
					</div>
				</div>
