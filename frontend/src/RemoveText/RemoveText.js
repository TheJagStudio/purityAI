...
const RemoveText = () => {
	...
	function removeText() {
		...
		setClipWidth(100);
		fetch(process.env.REACT_APP_SERVER + "/api/textRemoval/", requestOptions)
		...
		<>
			<section className="w-full min-h-screen scroll-smooth">
				<FunctionalityHeading
					...
					func="Text remover"
					funcDesc="Remove text from any image"
					funcIMG="/static/images/text-remove.jpg"
				/>
				...
				{/* Output Section */}
				<section className="relative flex flex-col md:flex-row max-w-[1200px] lg:w-full sm:w-[calc(100%-6rem)] w-[calc(100%-4rem)] h-0 p-0 overflow-hidden lg:mx-auto sm:mx-12 mx-8 md:gap-10 gap-5 justify-center items-center my-0 bg-dark-primary rounded-3xl transition-all duration-500" id="removeTextImage">
					<div
				...
				{/* Use Cases Section */}
				<section id="use-cases-section" className="w-full mt-16 my-12 flex flex-col items-center justify-center md:px-12 px-6">
						...
						<div className="flex gap-3 flex-col h-[750px] md:h-[630px]">
							...
							<Swiper ref={swiperRef} spaceBetween={50} slidesPerView={1} className="flex-1 w-full overflow-hidden flex flex-col flex-wrap">
								<SwiperSlide>
									<div className="w-full h-full transition-transform duration-700" style={{ transform: `translateX(0)` }}>
										<div className="md:min-w-[350px] flex flex-col justify-center">
											<p className="text-[13px] font-semibold text-white text-center my-8 hidden sm:block">Empty billboards to place the design of your client.</p>
											<div className="flex gap-4 justify-around">
												<div className="max-w-[400px] w-full h-[450px] relative flex justify-center items-center rounded-xl overflow-hidden">
													<img src="/static/images/TRUC1Trans.png" className="absolute max-w-[400px] w-full h-auto " alt="" />
													<img src="/static/images/TRUC1.jpg" className="max-w-[400px] w-full h-auto" alt="" style={{ clipPath: `polygon(0px 0px, ` + useCaseInputValue[0] + `% 0px, ` + useCaseInputValue[0] + `% 100%, 0px 100%)` }} />
													<div className={"w-[calc(100%-1.5rem)] mx-auto h-full absolute"}>
								...
								<SwiperSlide>
									<div className="w-full h-full transition-transform duration-700" style={{ transform: `translateX(0)` }}>
										<div className="md:min-w-[350px] flex flex-col justify-center">
											<p className="text-[13px] font-semibold text-white text-center my-8">Clean text on an object to create amazing concepts.</p>
											<div className="flex gap-4 justify-around">
												<div className="rounded-xl overflow-hidden">
													<div className="relative h-full rounded-xl overflow-hidden">
														<div className="max-w-[400px] w-full h-full relative flex justify-center items-center rounded-xl overflow-hidden">
															<img src="/static/images/TRUC2Trans.png" className="absolute max-w-[400px] w-full h-auto " alt="" />
															<img src="/static/images/TRUC2.jpg" className="max-w-[400px] w-full h-auto" alt="" style={{ clipPath: `polygon(0px 0px, ` + useCaseInputValue[1] + `% 0px, ` + useCaseInputValue[1] + `% 100%, 0px 100%)` }} />
															<div className={"w-[calc(100%-1.5rem)] mx-auto h-full absolute"}>
								...
								<SwiperSlide>
									<div className="w-full h-full transition-transform duration-700" style={{ transform: `translateX(0)` }}>
										<div className="md:min-w-[350px] flex flex-col justify-center">
											<p className="text-[13px] font-semibold text-white text-center my-8">Remove or replace unwanted messages or sign on your photos.</p>
											<div className="flex gap-4 justify-around">
												<div className="rounded-xl overflow-hidden">
													<div className="relative h-full rounded-xl overflow-hidden">
														<div className="max-w-[400px] w-full h-[450px] relative flex justify-center items-center rounded-xl overflow-hidden">
															<img src="/static/images/TRUC3Trans.png" className="absolute max-w-[400px] w-full h-auto " alt="" />
															<img src="/static/images/TRUC3.jpg" className="max-w-[400px] w-full h-auto" alt="" style={{ clipPath: `polygon(0px 0px, ` + useCaseInputValue[2] + `% 0px, ` + useCaseInputValue[2] + `% 100%, 0px 100%)` }} />
															<div className={"w-[calc(100%-1.5rem)] mx-auto h-full absolute"}>
								...
								<SwiperSlide>
									<div className="w-full h-full transition-transform duration-700" style={{ transform: `translateX(0)` }}>
										<div className="md:min-w-[350px] flex flex-col justify-center">
											<p className="text-[13px] font-semibold text-white text-center my-8">Remove the brand names of all the products you don't sell on your site.</p>
											<div className="flex gap-4 justify-around">
												<div className="rounded-xl overflow-hidden">
													<div className="relative h-full rounded-xl overflow-hidden">
														<div className="max-w-[400px] w-full h-[450px] relative flex justify-center items-center rounded-xl overflow-hidden">
															<img src="/static/images/TRUC4Trans.png" className="absolute max-w-[400px] w-full h-auto object-cover object-center" alt="" />
															<img src="/static/images/TRUC4.jpg" className="max-w-[400px] w-full h-auto object-cover object-center" alt="" style={{ clipPath: `polygon(0px 0px, ` + useCaseInputValue[3] + `% 0px, ` + useCaseInputValue[3] + `% 100%, 0px 100%)` }} />
															<div className={"w-[calc(100%-1.5rem)] mx-auto h-full absolute"}>
																<div className={"absolute bg-white w-0.5 -translate-x-[0.075rem] h-full"} style={{ left: useCaseInputValue[3] + "%" }}></div>
															</div>
